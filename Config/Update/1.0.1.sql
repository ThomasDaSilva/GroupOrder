...
(
    `id` INTEGER NOT NULL AUTO_INCREMENT,
    `sub_customer_id` INTEGER NOT NULL,
    `group_order_cart_id` INTEGER NOT NULL,
...
DROP TABLE IF EXISTS `group_order_cart`;

CREATE TABLE `group_order_cart`
(
    `id` INTEGER NOT NULL AUTO_INCREMENT,
    `main_customer_id` INTEGER NOT NULL,
    ...
    `date_end` DATE,
    PRIMARY KEY (`id`),
    INDEX `fi_group_order_cart_main_customer_id` (`main_customer_id`),

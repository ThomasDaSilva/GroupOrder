...
abstract class GroupOrderCartItem implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\GroupOrder\\Model\\Map\\GroupOrderCartItemTableMap';
    ...
    /**
     * Initializes internal state of GroupOrder\Model\Base\GroupOrderCartItem object.
     */
    ...
    /**
     * Compares this with another <code>GroupOrderCartItem</code> instance.  If
     * <code>obj</code> is an instance of <code>GroupOrderCartItem</code>, delegates to
     * <code>equals(GroupOrderCartItem)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return GroupOrderCartItem The current object, for fluid interface
     */
     ...
     * @return   \GroupOrder\Model\GroupOrderCartItem The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[GroupOrderCartItemTableMap::ID] = true;
        }
    ...
    public function setSubCustomerId($v)
    {
        ...
        if ($this->sub_customer_id !== $v) {
            ...
            $this->modifiedColumns[GroupOrderCartItemTableMap::SUB_CUSTOMER_ID] = true;
        }
    ...
    public function setCartItemId($v)
    {
        ...
        if ($this->cart_item_id !== $v) {
            $this->cart_item_id = $v;
            $this->modifiedColumns[GroupOrderCartItemTableMap::CART_ITEM_ID] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : GroupOrderCartItemTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : GroupOrderCartItemTableMap::translateFieldName('SubCustomerId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->sub_customer_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : GroupOrderCartItemTableMap::translateFieldName('CartItemId', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 3; // 3 = GroupOrderCartItemTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating \GroupOrder\Model\GroupOrderCartItem object", 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildGroupOrderCartItemQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see GroupOrderCartItem::setDeleted()
     * @see GroupOrderCartItem::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        try {
            $deleteQuery = ChildGroupOrderCartItemQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                GroupOrderCartItemTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(GroupOrderCartItemTableMap::ID)) {
            $modifiedColumns[':p' . $index++]  = 'ID';
        }
        if ($this->isColumnModified(GroupOrderCartItemTableMap::SUB_CUSTOMER_ID)) {
            $modifiedColumns[':p' . $index++]  = 'SUB_CUSTOMER_ID';
        }
        if ($this->isColumnModified(GroupOrderCartItemTableMap::CART_ITEM_ID)) {
            $modifiedColumns[':p' . $index++]  = 'CART_ITEM_ID';
        }

        $sql = sprintf(
            'INSERT INTO group_order_cart_item (%s) VALUES (%s)',
    ...
    {
        $pos = GroupOrderCartItemTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['GroupOrderCartItem'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['GroupOrderCartItem'][$this->getPrimaryKey()] = true;
        $keys = GroupOrderCartItemTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(GroupOrderCartItemTableMap::ID)) $criteria->add(GroupOrderCartItemTableMap::ID, $this->id);
        if ($this->isColumnModified(GroupOrderCartItemTableMap::SUB_CUSTOMER_ID)) $criteria->add(GroupOrderCartItemTableMap::SUB_CUSTOMER_ID, $this->sub_customer_id);
        if ($this->isColumnModified(GroupOrderCartItemTableMap::CART_ITEM_ID)) $criteria->add(GroupOrderCartItemTableMap::CART_ITEM_ID, $this->cart_item_id);
    ...
    {
        $criteria = new Criteria(GroupOrderCartItemTableMap::DATABASE_NAME);
        $criteria->add(GroupOrderCartItemTableMap::ID, $this->id);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \GroupOrder\Model\GroupOrderCartItem (or compatible) type.
     ...
     *
     * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return                 \GroupOrder\Model\GroupOrderCartItem Clone of current object.
     * @throws PropelException
     */
    ...
    public function getGroupOrderSubCustomer(ConnectionInterface $con = null)
    {
        if ($this->aGroupOrderSubCustomer === null && ($this->sub_customer_id !== null)) {
            ...
            /* The following can be used additionally to
                ...
                $this->aGroupOrderSubCustomer->addGroupOrderCartItems($this);
             */
        }
    ...
    public function getCartItem(ConnectionInterface $con = null)
    {
        if ($this->aCartItem === null && ($this->cart_item_id !== null)) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aCartItem->addGroupOrderCartItems($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(GroupOrderCartItemTableMap::DEFAULT_STRING_FORMAT);
    }
